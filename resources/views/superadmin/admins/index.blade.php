                    ...
                    <div class="table-responsive">
                        <table class="table table-striped common-table">
                            ...
                            <tbody>
                                ...
                                @php
                                $cryptStr= Crypt::encryptString($au->user_slug);
                                ...
                                <tr>
                                    ...
                                    <td><a href="{{url('/superadmin/admin/edit/'.$au->id)}}" class='item-edit text-blue' title='Edit'><svg xmlns='http://www.w3.org/2000/svg' width='24' height='24' viewBox='0 0 24 24' fill='none' stroke='currentColor' stroke-width='2' stroke-linecap='round' stroke-linejoin='round' class='feather feather-edit font-small-4'>
