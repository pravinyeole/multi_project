            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <button type="button" form="manaualAssign" class="btn btn-success col-sm-3" id="assign-user-btn">Submit Assigned User</button>
                    </div>
                    <div class="card-body">
                                    ...
                                    <tbody id="manaualAssignRadio">
                                        ...
                                        <tr>
                                            <td>
                                                ...
                                                <label radiovalue="{{ $user->id }}" radioname="{{ $user->user_fname }}_{{ $user->user_lname }}" class="col-sm-4 control-label" id="manaual_radio_{{$key}}">
