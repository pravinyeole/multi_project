                                        ...
                                        <div class="card card-rounded">
                                            <div class="card-body">
                                                    ...
                                                    <div class="me-3">
                                                        <div id="marketing-overview-legend">
                                                            <div class="chartjs-legend">
                                                                <ul>
                                                                    <li class="text-muted text-small"><span style="background-color:#52CDFF"></span>Last week</li>
                                                                    <li class="text-muted text-small"><span style="background-color:#1F3BB3"></span>This week</li>
                                                                </ul>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="chartjs-bar-wrapper mt-3">
                                                    ...
                                                    <canvas id="marketingOverview" style="display: block; height: 150px; width: 747px;" width="933" height="187" class="chartjs-render-monitor"></canvas>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="card-body">
                                                <div class="row">
                                                    <div class="col-lg-12">
                                                        ...
                                                        <canvas class="my-auto chartjs-render-monitor" id="doughnutChart" height="278" width="418" style="display: block; height: 223px; width: 335px;"></canvas>
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-12">
                                                        ...
                                                        <div class="mt-3">
                                                            ...
                                                            <canvas id="leaveReport" width="418" height="187" style="display: block; height: 150px; width: 335px;" class="chartjs-render-monitor"></canvas>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
