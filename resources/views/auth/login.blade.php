  ...
  <div class="auth-inner py-2">
    <div class="d-flex justify-content-center align-items-center container">
      <div class="py-5 px-3" style="border: 3px solid #1a75bc;border-radius: 30px;">
          <img src="{{asset('images/logo/otp-logo-1.png')}}" width="100%" style="height: 260px"  class="enterphone"  id="otp-logo-1" />
          <img src="{{asset('images/logo/otp-logo-2.png')}}" width="100%" style="height: 260px"  class="veritifcation-otp d-none" id="otp-logo-2"/>
        <h2 class="m-0 text-center login-title">Enter Phone</h2>
        <form id="mobileForm" method="POST" action="{{url('login')}}">
          @csrf <!-- Add CSRF token field -->
          <div class="mt-2">
            <input type="text" class="form-control" name="mobileNumber" id="mobileNumber" maxlength="10" placeholder="Enter your mobile number">
          </div>
          ...
          <div class="text-center mt-2">
            <button id="getOtpBtn" class="btn btn-primary">Get OTP</button>
