      ...
      <div class="content-wrapper login-wrapper background-none d-flex align-items-center auth px-0 justify-content-center">
            <div class="auth-form-light text-center p-0">
              ...
              <!-- <h6 class="fw-light">Sign in to continue.</h6> -->
                ...
                <div class="">
                  <button id="getOtpBtn" class="btn btn-block btn-primary btn-lg font-weight-medium auth-form-btn mt-1">Login Again</button>
                </div>
                </form>
                <div class="seprator"></div>
                <div class="d-flex justify-content-between gap-2">
                    <img src="{{asset('images/digital-india.png')}}" alt="logo" style="max-width:200px;margin: 0 auto;">
                    <img src="{{asset('images/make-india.png')}}" alt="logo" style="max-width:200px;margin: 0 auto;">
                </div>
