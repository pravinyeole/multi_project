                    ...
                    <div class="alert alert-success note" role="alert">
                        <div class="row align-items-start">
                            ...
                            <p>Kindly send ₹{{config('custom.custom.upi_pay_amount')}} to below user and share payment screenshot with the user directly.</p>
                             <button type="button" class="btn btn-warning btn-sm waves-effect waves-float waves-light my-2" onclick="svgdown(<?php echo $result_data->id ?>,'<?php echo $tr;?>')">Download QR</button>
                             </div>  
                        </div>
                    </div>
