...
<section class="bs-validation">
    <div class="row">
        ...
        <div class="col-12">
            <form id="addDepartment" method="POST" class="addDepartment" action="{{url('class/save')}}" autocomplete="off">
                @csrf
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title"> {{__("labels.class.add_class")}}<span style="font-size: 13px"></span></h4>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="class_name" name="class_name" placeholder='{{__("labels.department.title")}}' value="{{old('name')}}" maxlength="100" required="" onkeypress='return ((event.charCode >= 65 && event.charCode <= 90) || (event.charCode >= 97 && event.charCode <= 122) || (event.charCode == 32))'>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control select2" id="class_status" name="class_status" required>
