...
@section('content')
                            ...
                            <div class="dt-buttons d-inline-flex">
                                ...
                                @if(Auth::user()->user_role != "S")
                                    ...
                                    {{-- @if($timer == 'start' || !empty($timer)) --}}
                                        <button class="dt-button create-new btn btn-primary {{$createIdLimit ?? ''}}" tabindex="0" type="button"
    ...
    <div class="modal fade" id="modals-slide-in" tabindex="-1" role="dialog" aria-labelledby="exampleModalSlideLabel"
